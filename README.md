...
## DPO Pay WooCommerce plugin v1.1.3 for WooCommerce v7.6.0
...
latest release (v1.1.3) and unzip. You will then be able to follow the integration guide PDF which is included in the
zip.
