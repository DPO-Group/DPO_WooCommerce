...
## DPO Pay WooCommerce plugin v1.1.5 for WooCommerce v8.9.1
...
latest release (v1.1.5) and unzip. You will then be able to follow the integration guide PDF which is included in the
zip.
